...
class customGWPJS {
    ...
    cartGWP(){
        ...
        if(GWP.enable == 'true'){
            if(GWP.threashould_3['enable'] && cartTotal >= GWP.threashould_3['amount']){
                eligibleThreshould = 3;
            }else if(GWP.threashould_2['enable'] && cartTotal >= GWP.threashould_2['amount']){
                eligibleThreshould = 2;
            }else if(GWP.threashould_1['enable'] && cartTotal >= GWP.threashould_1['amount']){
    ...
    addFreeProToCart(originalThreshouldAmount, eligibleFreeProductJSON){
